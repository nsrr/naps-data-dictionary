NAPS Data Dictionary
======================

[![Build Status](https://app.travis-ci.com/nsrr/naps-data-dictionary.svg?token=ZaEiSnjDVx3CsHkJja6Q&branch=master)](https://travis-ci.com/nsrr/naps-data-dictionary)

### Exports

The NAPS data dictionary can be exported to CSV by typing:
...
The NAPS data dictionary is tested using the
...
[CHANGELOG](https://github.com/nsrr/naps-data-dictionary/blob/master/CHANGELOG.md).
