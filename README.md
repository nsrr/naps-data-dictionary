Naps-data-dictionary Data Dictionary
======================

[![Build Status](https://travis-ci.com/<REPOSITORY>/naps-data-dictionary-data-dictionary.svg?branch=master)](https://travis-ci.com/<REPOSITORY>/naps-data-dictionary-data-dictionary)

### Exports

The naps-data-dictionary data dictionary can be exported to CSV by typing:
...
The naps-data-dictionary data dictionary is tested using the
...
[CHANGELOG](https://github.com/<REPOSITORY>/naps-data-dictionary-data-dictionary/blob/master/CHANGELOG.md).
